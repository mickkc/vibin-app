    ...
    routes: [
      ShellRoute(
        ...
        routes: [
          ...
          GoRoute(path: '/sessions', builder: (context, state) => SessionManagementPage()),
          GoRoute(path: '/tasks', builder: (context, state) => TaskManagementPage()),
          GoRoute(path: '/uploads', builder: (context, state) => UploadPage()),
        ],
      )
    ],
